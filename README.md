...
│   ├── 1ª Semana
│   │   ├── 1-Aula1.R
│   │   └── 1.1 - introducao-r-rstudio.pdf
│   └── a - atividades
│       └── a_atv1.R
├── 2.Tipos de Dados e Estruturas Basicas
│   ├── 2ª Semana
│   │   ├── 2 - Aula2.R
│   │   └── 2.1 - tipos-de-dados-e-estruturas.pdf
│   └── b - atividades
│       └── b_atv2.R
├── 3.Introdução ao tidyverse
│   ├── 3ª Semana
│   │   ├── 3 - Aula3.R
│   │   └── 3.1 - introducao-ao-tidyverse.pdf
│   └── c - atividades
│       └── c_atv3.R
├── 4.Visualização de dados com ggplot2
│   ├── 4ª Semana
│   │   ├── 4 - Aula4.R
│   │   └── 4.1 - Visualizacao-de-dados.pdf
│   └── d - atividades
│       └── d.1- atividades
│           ├── d.1.1 - atividade
│           │   └── d.1.1_atv4.R
│           └── d.1.2 - gráficos_plotados.png
│               ├── Distribuição_do_peso_dos_diamantes.png
│               ├── Quantidade_de_carros_por_fabricante.png
│               └── taxa_poupanca_pessoal.png
├── 5.Funções, estrutura de controle e repetição
│   ├── 5ª Semana
│   │   ├── 5 - Controle_funcoes_repeticoes .Rmd
│   │   └── 5.1 - Controle_funcoes_repeticoes.pdf
│   └── e - atividade
│       └── e_atv5.R
├── 6.Challenge
│   ├── 1.dados
│   │   ├── a-vendas.csv
│   │   ├── b-MICRODADOS_ED_SUP_IES_2023.CSV
│   │   ├── c-planilha_exemplo_com_nas.csv
│   │   └── d-dados_final.csv
│   └── 2.desafios
│       ├── a-challenge1.R
│       ├── b-challenge2.R
